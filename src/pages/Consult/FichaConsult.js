							...
							<Col>
								{item.anamnese.unhas_formato.involuta.length > 0 && (
									<label className="mr-2">
										{' '}
										Involuta -{' '}
										{item.anamnese.unhas_formato.involuta.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.unhas_lesoes.onicorrexe.length > 0 && (
									<label className="mr-2">
										{' '}
										Onicorrexe -{' '}
										{item.anamnese.unhas_lesoes.onicorrexe.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.unhas_lesoes.onicolise.length > 0 && (
									<label className="mr-2">
										{' '}
										Onicolise -{' '}
										{item.anamnese.unhas_lesoes.onicolise.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.unhas_lesoes.onicomicose.length > 0 && (
									<label className="mr-2">
										{' '}
										Onicomicose -{' '}
										{item.anamnese.unhas_lesoes.onicomicose.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.unhas_lesoes.psoriase.length > 0 && (
									<label className="mr-2">
										{' '}
										Psoriase -{' '}
										{item.anamnese.unhas_lesoes.psoriase.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.unhas_lesoes.granuloma.length > 0 && (
									<label className="mr-2">
										{' '}
										Granuloma -{' '}
										{item.anamnese.unhas_lesoes.granuloma.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.unhas_lesoes.alter_cor.length > 0 && (
									<label className="mr-2">
										{' '}
										Alteração Cor -{' '}
										{item.anamnese.unhas_lesoes.alter_cor.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.unhas_lesoes.onicofose.length > 0 && (
									<label className="mr-2">
										{' '}
										Onicofose -{' '}
										{item.anamnese.unhas_lesoes.onicofose.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.unhas_lesoes.exostose.length > 0 && (
									<label className="mr-2">
										{' '}
										Exostose -{' '}
										{item.anamnese.unhas_lesoes.exostose.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.unhas_lesoes.onicomadese.length > 0 && (
									<label className="mr-2">
										{' '}
										Onicomadese -{' '}
										{item.anamnese.unhas_lesoes.onicomadese.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
					...
					<Col>
						<Form.Group controlId="exampleForm.ControlTextarea1">
							...
							<Form.Control
								...
								rows="3"
								disabled
								value={item.anamnese.unhas_lesoes.outros}
							/>
						</Form.Group>
					</Col>
				</Row>
							...
							<Col>
								{item.anamnese.pele_lesoes.bromidrose.length > 0 && (
									<label className="mr-2">
										{' '}
										Bromidrose -{' '}
										{item.anamnese.pele_lesoes.bromidrose.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.pele_lesoes.hiperhidrose.length > 0 && (
									<label className="mr-2">
										{' '}
										Hiperhidrose -{' '}
										{item.anamnese.pele_lesoes.hiperhidrose.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.pele_lesoes.tinea_pedis.length > 0 && (
									<label className="mr-2">
										{' '}
										Tinea Pedis -{' '}
										{item.anamnese.pele_lesoes.tinea_pedis.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.pele_lesoes.desidrose.length > 0 && (
									<label className="mr-2">
										{' '}
										Desidrose -{' '}
										{item.anamnese.pele_lesoes.desidrose.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								<Form.Group controlId="exampleForm.ControlTextarea1">
									...
									<Form.Control
										...
										rows="3"
										disabled
										value={item.anamnese.pele_lesoes.outros}
									/>
								</Form.Group>
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.orto_lesoes.halux_valgus.length > 0 && (
									<label className="mr-2">
										{' '}
										Halux Valgus -{' '}
										{item.anamnese.orto_lesoes.halux_valgus.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.orto_lesoes.tipo_pe.length > 0 && (
									<label className="mr-2">
										{' '}
										Tipos de pé -{' '}
										{item.anamnese.orto_lesoes.tipo_pe.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								{item.anamnese.orto_lesoes.tipos_dedos.length > 0 && (
									<label className="mr-2">
										{' '}
										Tipo de dedos -{' '}
										{item.anamnese.orto_lesoes.tipos_dedos.map((item) => item.label).join()}
									</label>
								)}
							</Col>
						</Row>
							...
							<Col>
								<Form.Group controlId="exampleForm.ControlTextarea1">
									...
									<Form.Control
										...
										rows="3"
										disabled
										value={item.anamnese.orto_lesoes.outros}
									/>
								</Form.Group>
							</Col>
						</Row>
